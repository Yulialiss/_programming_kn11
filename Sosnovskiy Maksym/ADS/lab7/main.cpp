...
void CheckPalindr() {
    Stack st;
    string text;       // оригінальний рядок
    string clean = ""; // рядок без пробілів
    ...
    for (size_t i = 0; i < clean.size(); i++) { // записуємо всі символи у стек
        st.Push(clean[i]);
    }
...
int main() {
    ...
    do {
        ...
        // Очищаємо буфер ПІСЛЯ числових значень, щоб getline працював коректно
        cin.ignore(1000, '\n');
